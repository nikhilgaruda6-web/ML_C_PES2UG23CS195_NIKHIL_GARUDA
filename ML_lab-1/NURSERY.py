...
def construct_tree(data, cols, used_attributes=None, level=0, max_depth=6):
...
# -------------------------------
# MAIN: Run on Nursery Dataset
# -------------------------------
if __name__ == "__main__":
    # Load data
    df = pd.read_csv(r"C:\Users\Nikhil\Downloads\all\Nursery.csv")
    ...
    tree = construct_tree(train_data, cols, max_depth=6)
